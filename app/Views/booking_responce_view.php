                        ...
                        <div class="content">
                            <div class="post_item post_item_single post_format_standard page">
                                <section class="post_content">
                                    ...
                                    <h4 class="fw-bold" style="text-align: center;">Booking Response</h4><br>
            <h3 class="fw-bold" style="text-align: center;">Thank you for your booking</h3>
            <p class="fw-bold" style="text-align: center;">We have recieved your booking request. We will process and verify your booking details and contact you on the given mobile number.</p>
