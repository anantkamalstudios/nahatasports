                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="profileTab" role="tabpanel">
                                <div class="card-body personal-info">
                                    <!-- shankar -->
                                    <form action="<?= base_url('save_hero') ?>" method="post"
                                        enctype="multipart/form-data">
                                        <!-- Slide Background Image -->
                                        <div class="mb-4">
                                            <label for="slide_image" class="form-label fw-semibold">Background
                                                Image:</label>
                                            <input id="slide_image" name="slide_image" type="file" accept="image/*"
                                                class="form-control" required>
                                        </div>

                                        <!-- Slide Title -->
                                        <div class="mb-4">
                                            <label for="slide_title" class="form-label fw-semibold">Title:</label>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="url" name="button1_url" class="form-control"
                                                placeholder="Button 1 URL" required>
                                        </div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="url" name="button2_url" class="form-control"
                                                placeholder="Button 2 URL" required>
                                        </div>
                                        ...
                                        <div class="alert alert-success mt-3"><?= session()->getFlashdata('success') ?>
                                        </div>
                                        <?php endif; ?>
                                    </form>
                                    <!-- shankar -->
