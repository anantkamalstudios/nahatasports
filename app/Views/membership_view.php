                        ...
                        <div class="panel_top">
                            <nav class="menu_main_nav_area">
                                <ul id="menu_main_mobile" class="menu_main_nav">
                                    ...
                                    <li class="menu-item">
                                        <a href="tennis-lessons.html">Coaching</a>
                                    </li>
                                    <li class="menu-item menu-item-has-children">
                                        <a href="#">News</a>
                                        <ul class="sub-menu">
                                ...
                                <div class="sc_content content_wrap">
                                    ...
                                    <div class="text_uppercase margin_bottom_70_imp">
                                        <p class="price_blocks_subtitle text_align_center add_color_2 margin_auto">
                                            Tennis Club is honored to work with the country’s league best tennis players
                    ...
                    <div class="post_item post_item_single page">
                        <section class="post_content">
                            <div class="sc_content content_wrap questions_custom ">
                                <h3
                                    class="sc_title sc_title_underline sc_align_center margin_top_large text_align_center font_weight_600 font_size_3_571em">
                                        ...
                                        <div class="sc_accordion" data-active="0">
                                            <div class="sc_accordion_item odd first">
                                                <h5 class="sc_accordion_title">
                                                    <span
                                                        class="sc_accordion_icon sc_accordion_icon_closed icon-plus"></span>
                                                    <span
                                                        class="sc_accordion_icon sc_accordion_icon_opened icon-minus"></span>
                                                ...
                                                <div class="sc_accordion_content">
                                                    <p>Duis aute irure dolor in reprehenderit in voluptate velit esse
                                                        ...
                                                        laborum cillum dolore eu fugiat nulla pariatur.</p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="sc_accordion_item even">
                                                ...
                                                <div class="sc_accordion_content">
                                                    <p>Sed ut perspiciatis, unde omnis iste natus error sit voluptatem
                                                        ...
                                                        consequuntur magni dolores eo.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div><!-- /Accordion column 1 -->
                                    <!-- Accordion column 2 -->
                                ...
                                <div class="custom_link_style1 margin_top_small margin_bottom_70_imp">
                                    <p class="text_align_center">Contact the Club&#8217;s Membership Director for more
                                        information at
                                        <a href="#" target="_blank">info@yoursite.com</a>
                                    </p>
                                </div>
                            </div>
                        </section>
                    ...
                    <div class="columns_wrap">
                        ...
                        <aside class="column-1_3 widget widget_socials">
                            <div class="widget_inner">
                                ...
                                <div class="logo_descr">Lorem ipsum dolor sit amet, consect etur adipisicing elit, sed
                                    do eiusmod tempor incidt dolore magna aliqua.</div>
                                <div
                        ...
                        <div class="content">
                            <div class="post_item post_item_single page">
                                <section class="post_content">
                                    <div class="padding_top_0_imp padding_bottom_7_857em_imp">
                                        <div class="sc_content content_wrap">
                                            <h3 class="sc_title sc_title_underline sc_align_center text_align_center font_weight_600 font_size_3_571em">Choose your Package</h3>
                                            <div class="text_uppercase margin_bottom_70_imp">
                                                <p class="price_blocks_subtitle text_align_center add_color_2 margin_auto">
                                                    Tennis Club is honored to work with the country’s league best tennis players that now can become your personal coach and help you win
                                                </p>
                                            </div>
                                            <div class="columns_wrap sc_columns columns_nofluid sc_columns_count_4">
                                                <!-- Price Block -->
                    ...
                    <div class="content_wrap">
                        ...
                        <div class="content">
                            <div class="post_item post_item_single page">
                                <section class="post_content">
                                    <div class="sc_content content_wrap questions_custom ">
                                        <h3 class="sc_title sc_title_underline sc_align_center margin_top_large text_align_center font_weight_600 font_size_3_571em">Questions or Concerns</h3>
                                        <div class="columns_wrap sc_columns columns_nofluid sc_columns_count_2">
                                            <!-- Accordion column 1 -->
                                            <div class="column-1_2 sc_column_item sc_column_item_1 odd first">
                                                <div class="sc_accordion" data-active="0">
                                                    <div class="sc_accordion_item odd first">
                                                        ...
                                                        <div class="sc_accordion_content">
                                                            <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum cillum dolore eu fugiat nulla pariatur.</p>
                                                        </div>
                                                    </div>
                                                    <div class="sc_accordion_item even">
                                                        <h5 class="sc_accordion_title">
                                        ...
                                        <div class="custom_link_style1 margin_top_small margin_bottom_70_imp">
                                            <p class="text_align_center">Contact the Club&#8217;s Membership Director for more information at
                                                <a href="#" target="_blank">info@yoursite.com</a>
                                            </p>
                                        </div>
                                    </div>
...
=======
        ...
        <div class="copyright_wrap copyright_style_menu">
            <div class="copyright_wrap_inner">
                <div class="content_wrap">
                    <div class="copyright_text">
                        Copyright © 2025 <a href="https://anantkamalstudios.com/" target="_blank">AnantkamalStudios</a>.
                        All Rights Reserved.
                    </div>
                </div>
            </div>
