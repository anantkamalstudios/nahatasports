                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="profileTab" role="tabpanel">
                                <div class="card-body personal-info">
                                    <!-- shankar -->
                                    <form action="<?= base_url('save_courtorground') ?>" method="post"
                                        enctype="multipart/form-data">
                                        <h4 class="mb-4 fw-bold">Add Court or Ground</h4>

                                        <div class="mb-3">
                                            <label class="form-label fw-semibold">Name</label>
                                            <input type="text" name="name" class="form-control"
                                                placeholder="e.g. Badminton, Cricket" required>
                                        </div>

                                        <div class="mb-3">
                                            <label class="form-label fw-semibold">Description</label>
                                            <textarea name="description" class="form-control" rows="4"
                                                placeholder="Details like real-time availability, slot booking, etc."
                                                required></textarea>
                                        </div>
                                        ...
                                        <button type="submit" class="btn btn-primary w-100">Add Court or Ground</button>
                                    </form>
