                        ...
                        <div class="content">
                            <div class="post_item post_item_single post_format_standard page">
                                <section class="post_content">
                                    <h3 class="fw-bold">User Registration</h3>
    ...
    <div class="card shadow p-4" style="width: 100%; max-width: 400px;">
      ...
      <form class="w-100 mt-4 pt-2 registration_form" id="registration_form" action="javascript:void(0)" method="post">
       ...
       <div class="mt-5 text-muted">
                            ...
                            <a href="user_login" class="fw-bold">Login</a>
                        </div>
    </div>
  </div>
...
<script type="text/javascript" src="<?php echo base_url()?>assets/script/user_registration.js"></script>
