                            ...
                            <div class="tab-pane fade show active" id="profileTab" role="tabpanel">
                                <div class="card-body personal-info">
                                    <div class="mb-4 d-flex align-items-center justify-content-between">
                                        ...
                                        <a class="btn btn-primary" href="<?= base_url('add_program') ?>">Add Program</a>
                                    </div>
                                    <!-- shankar -->
                                        ...
                                        <div class="table-responsive">
                                            <table class="table mg-b-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="<?= base_url($program['image']) ?>"
                                                                alt="Program Image" style="width: 100px;">
                                                        </td>
                                                        <td><?= esc($program['location']) ?></td>
                                                        <td><?= esc($program['age_group']) ?></td>
                                                        <td><?= esc($program['timings']) ?></td>
                                                        <td><a href="<?= esc($program['booking_url']) ?>"
                                                                target="_blank"><?= esc($program['booking_url']) ?></a>
                                                        </td>
                                                        <td>
                                                            <a href="<?= base_url('edit_program/' . $program['id']) ?>"
                                                                class="btn btn-sm btn-primary">Edit</a>
                                                            <a href="<?= base_url('delete_program/' . $program['id']) ?>"
                                                    ...
                                                    <?php else : ?>
                                                    <tr>
                                                        <td colspan="8">No coaching programs found.</td>
                                                    </tr>
                                                    <?php endif; ?>
                                                </tbody>
                                            </table>
