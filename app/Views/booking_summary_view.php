...
<style>
    ...
    .row {
  display: flex;
  justify-content: space-between; /* left & right side */
  align-items: center;
  margin: 12px 0;
  color: #5f6f61;
  font-size: 16px;
                ...
                <div class="content">
                    <div class="post_item post_item_single post_format_standard page">
                        <section class="post_content">
                            ...
                            <h4 class="fw-bold" style="text-align: center;">Booking Summery</h4><br>
                            <div class="container">
                                <div class="card">
                                    <div class="row">
                                        <span>Total Slot Base Price</span>
                                        <span>₹900</span>
                                    </div>
                                    <div class="row">
                                ...
                                <div class="amount-card">
                                    ...
                                    <p class="note">
                                        <strong>Note:</strong> You can either pay full amount or you can pay any amount
                                        to confirm your slot and then pay the remaining amount at the counter.
                                    </p>
                                    <input type="text" placeholder="Enter amount" required>
                                </div>
                            </div>
                            <div class="bottom-bar" style="margin-left:75%;">
                                <a class="btn btn-primary" id="proceedBtn" href="<?= base_url() ?>qrcode">Proceed To
                                    Pay</a>
                            </div>
...
<div class="container">
  ...
  <div class="total">
    ...
    <div class="amount-card">
        <label>Enter booking amount:</label>
        <p class="note">
            <strong>Note:</strong> You can either pay full amount or you can pay any amount to confirm your slot and then pay the remaining amount at the counter.
        </p>
        <input type="text" placeholder="Enter amount"required>
    </div>
</div>
    <div class="bottom-bar" style="margin-left:75%;">
       <a class="btn btn-primary" id="proceedBtn" href="<?= base_url() ?>qrcode">Proceed To Pay</a>
    </div>
