                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="profileTab" role="tabpanel">
                                <div class="card-body personal-info">
                                    <!-- shankar -->
                                    <form action="<?= base_url('save_multicenter') ?>" method="post"
                                        enctype="multipart/form-data">
                                        <h4 class="mb-4 fw-bold">Add Multi-Center</h4>

                                        <!-- Center Name -->
                                        <div class="mb-3">
                                            <label class="form-label fw-semibold">Center Name</label>
                                            <input type="text" name="name" class="form-control"
                                                placeholder="e.g. Sinhagad Road, Gangadham Chowk" required>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="address" class="form-control" rows="3"
                                                placeholder="Full address here..." required></textarea>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="sports" class="form-control"
                                                placeholder="Comma-separated e.g. Badminton, Swimming, Yoga" required>
                                        </div>
                                        ...
                                        <button type="submit" class="btn btn-primary w-100">Add Multi-Center</button>
                                    </form>
