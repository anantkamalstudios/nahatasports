                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="profileTab" role="tabpanel">
                                <div class="card-body personal-info">
                                    <!-- shankar -->
                                    <form action="<?= base_url('update_courtorground/' . $court['id']) ?>" method="post"
                                        enctype="multipart/form-data" class="p-4 border rounded bg-light">
                                        <h4 class="mb-4 fw-bold">Edit Court or Ground</h4>

                                        <div class="mb-3">
                                            <label class="form-label fw-semibold">Name</label>
                                            <input type="text" name="name" class="form-control"
                                                value="<?= esc($court['name']) ?>" required>
                                        </div>

                                        <div class="mb-3">
                                            <label class="form-label fw-semibold">Description</label>
                                            <textarea name="description" class="form-control" rows="4"
                                                required><?= esc($court['description']) ?></textarea>
                                        </div>

                                        <div class="mb-3">
                                            <label class="form-label fw-semibold">Current Image</label><br>
                                            <img src="<?= base_url($court['image']) ?>" alt="Current Image"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="url" name="booking_url" class="form-control"
                                                value="<?= esc($court['booking_url']) ?>" required>
                                        </div>

                                        <button type="submit" class="btn btn-primary w-100">Update Court or
                                            Ground</button>
                                    </form>
