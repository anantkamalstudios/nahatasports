                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="profileTab" role="tabpanel">
                                <div class="card-body personal-info">
                                    <!-- shankar -->
                                    <form action="<?= base_url('update_program/' . $program['id']) ?>" method="post"
                                        enctype="multipart/form-data" class="p-4 border rounded bg-light">
                                        <h4 class="mb-4 fw-bold">Edit Coaching Program</h4>

                                        <div class="mb-3">
                                            <label class="form-label fw-semibold">Title</label>
                                            <input type="text" name="title" class="form-control"
                                                value="<?= esc($program['title']) ?>" required>
                                        </div>

                                        <div class="mb-3">
                                            <label class="form-label fw-semibold">Current Image</label><br>
                                            <img src="<?= base_url($program['image']) ?>" alt="Program Image"
