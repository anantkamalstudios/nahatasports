                                ...
                                <div class="card-body personal-info">
                                    <div class="mb-4 d-flex align-items-center justify-content-between">
                                        <h5 class="fw-bold mb-0 me-4">
                                            <span class="d-block mb-2">Hero Section</span>
                                            <span class="fs-12 fw-normal text-muted text-truncate-1-line"></span>
                                        </h5>
                                        <a class="btn btn-primary" href="<?= base_url('add_courtorground') ?>">Add
                                            Court or Ground</a>
                                    </div>
                                    <!-- shankar -->
                                            ...
                                            <table class="table mg-b-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?= nl2br(esc($court['description'])) ?></td>
                                                        <td>
                                                            <img src="<?= base_url($court['image']) ?>"
                                                                alt="Court Image" style="width: 100px;">
                                                        </td>
                                                        <td><?= esc($court['booking_url']) ?></td>
                                                        <td>
                                                            <a href="<?= base_url('edit_courtorground/' . $court['id']) ?>"
                                                                class="btn btn-sm btn-primary">Edit</a>
                                                            <a href="<?= base_url('delete_courtorground/' . $court['id']) ?>"
                                                                onclick="return confirm('Are you sure you want to delete this court/ground?');"
                                                    ...
                                                    <?php else : ?>
                                                    <tr>
                                                        <td colspan="6">No court/ground data found.</td>
                                                    </tr>
                                                    <?php endif; ?>
                                                </tbody>
                                            </table>
