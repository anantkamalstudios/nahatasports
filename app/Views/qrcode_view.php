                    ...
                    <div class="content">
                        <div class="post_item post_item_single post_format_standard page">
                            <section class="post_content">
                                ...
                                <h4 class="fw-bold" style="text-align: center;">Please Make The Payment</h4><br>
                                <div class="qr-container">
                                    <!-- Replace src with your QR image -->
                                    <img src="<?=base_url()?>assets/images/images.png" alt="QR Code">
                                    <p class="upi-id">UPI ID: rnahata79@okhdfcbank</p>

                                    <p class="instruction">Scan this code to pay me</p>

                                    <p class="bold-note">Please scan the QR code and make the payment of Rs.300</p>

                                    <p class="balance-info">Your remaining balance amount : Rs.-300</p>

                                    <h3>Enter Your Transaction ID:</h3>
                                    <input type="text" placeholder="Enter Transaction ID">

                                    <a class="btn btn-primary" href="<?= base_url() ?>book_res">Submit</a>
                                </div>
