                                ...
                                <div class="card-body personal-info">
                                    <div class="mb-4 d-flex align-items-center justify-content-between">
                                        <h5 class="fw-bold mb-0 me-4">
                                            <span class="d-block mb-2">Student Parents</span>
                                            <span class="fs-12 fw-normal text-muted text-truncate-1-line"></span>
                                        </h5>
                                        <a class="btn btn-primary" href="<?= base_url('add_studentparents') ?>">Add
                                            Program</a>
                                    </div>
                                    <!-- shankar -->
                                    <div class="section-wrapper">
                                        <div class="table-responsive">
                                            <table class="table mg-b-0">
                                                ...
                                                <tbody>
                                                    <?php if (!empty($studentparents)) : ?>
                                                    <?php foreach ($studentparents as $feature) : ?>
                                                    <tr>
                                                        <td><?= esc($feature['id']) ?></td>
                                                        <td><?= esc($feature['feature_text']) ?></td>
                                                        <td>
                                                            <a href="<?= base_url('edit_studentparent/' . $feature['id']) ?>"
                                                                class="btn btn-sm btn-primary">Edit</a>
                                                            <a href="<?= base_url('delete_studentparent/' . $feature['id']) ?>"
                                                    ...
                                                    <?php else : ?>
                                                    <tr>
                                                        <td colspan="3">No student/parent features found.</td>
                                                    </tr>
                                                    <?php endif; ?>
                                                </tbody>
                                            </table>
