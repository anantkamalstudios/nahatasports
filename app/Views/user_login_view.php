...
<link href="https://cdn.jsdelivr.net/npm/bootstrap-icons/font/bootstrap-icons.css" rel="stylesheet">
    ...
    .custom-card {
      width: 100%;
      max-width: 500px; /* Wider than before (was 400px) */
                                  ...
                                  <!--   <div class="menu_main_wrap">
                                        ...
                                        <nav class="menu_main_nav_area">
                                            <ul id="menu_main" class="menu_main_nav">
                                                ...
                                                <li class="menu-item">
                                                    <a href="<?= base_url() ?>tenis">Lessons</a>
                                                </li>
    ...
    <div class="card shadow p-4" style="width: 100%; max-width: 400px;">
      ...
      <form class="login_form" id="login_form" action="javascript:void(0)" method="post">
        <div class="mb-3">
        ...
        <div class="d-flex align-items-center justify-content-between mb-3">
          ...
          <a href="auth-reset-minimal.html" class="text-decoration-none fs-6 text-primary">Forgot password?</a>
        </div>
        <div>
          <button class="btn btn-primary w-100" name="login_save" id="login_save">Login</button>
        </div>
        <div id="user_error" class="text-danger mt-3" role="alert" style="display:none;"></div>
      </form>
      <div class="mt-5 text-muted">
                            <span> Don't have an account?</span>
                            <a href="<?php echo base_url();?>user_register" class="fw-bold">Create an Account</a>
                        </div>
    </div>
  </div>
...
<script type="text/javascript" src="<?php echo base_url()?>assets/script/user_login.js"></script>
