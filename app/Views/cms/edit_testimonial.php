                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="profileTab" role="tabpanel">
                                <div class="card-body personal-info">
                                    <!-- shankar -->
                                    <form action="<?= base_url('update_testimonial/' . $testimonial['id']) ?>"
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <select name="role" id="role" class="form-control" required>
                                                ...
                                                <option value="Parent"
                                                    <?= ($testimonial['role'] == 'Parent') ? 'selected' : '' ?>>Parent
                                                </option>
                                                <option value="Student"
                                                    <?= ($testimonial['role'] == 'Student') ? 'selected' : '' ?>>Student
                                                </option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <textarea name="message" id="message" class="form-control" rows="5"
                                                required><?= esc($testimonial['message']) ?></textarea>
                                        </div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <img src="<?= base_url('uploads/testimonials/' . $testimonial['image']) ?>"
                                                alt="<?= esc($testimonial['name']) ?>" class="mt-2 rounded-circle"
                                        ...
                                        <div class="mt-4 d-flex justify-content-between align-items-center">
                                            ...
                                            <a href="<?= base_url('testimonials') ?>" class="btn btn-secondary">Back to
                                                List</a>
                                        </div>
                                        ...
                                        <div class="alert alert-danger mt-3"><?= session()->getFlashdata('error') ?>
                                        </div>
                                        <?php endif; ?>
                                    </form>
