                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="profileTab" role="tabpanel">
                                <div class="card-body personal-info">
                                    <!-- shankar -->
                                    <form action="<?= base_url('update_event/' . $event['id']) ?>" method="post">
                                        <!-- Title -->
                                        <div class="mb-4">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <textarea name="description" id="description" class="form-control" rows="5"
                                                required><?= esc($event['description']) ?></textarea>
                                        </div>

                                        <!-- Button Title -->
                                        <div class="mb-4">
                                            <label for="btn_title" class="form-label fw-semibold">Button Title:</label>
                                            <input type="text" name="btn_title" id="btn_title" class="form-control"
                                                value="<?= esc($event['btn_title']) ?>"
                                                placeholder="Button Title (e.g., View Details)">
                                        </div>

                                        <!-- Button URL -->
                                        <div class="mb-4">
                                            <label for="btn_url" class="form-label fw-semibold">Button URL:</label>
                                            <input type="text" name="btn_url" id="btn_url" class="form-control"
                                                value="<?= esc($event['btn_url']) ?>"
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mt-4">
                                            ...
                                            <a href="<?= base_url('events') ?>" class="btn btn-secondary">Back to All
                                                Events</a>
                                        </div>
