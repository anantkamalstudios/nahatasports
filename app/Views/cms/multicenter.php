                ...
                <div class="col-lg-12">
                    <div class="card border-top-0">
                                ...
                                <div class="card-body personal-info">
                                    <div class="mb-4 d-flex align-items-center justify-content-between">
                                        <h5 class="fw-bold mb-0 me-4">
                                            <span class="d-block mb-2">Aour Multi Centers</span>
                                            <span class="fs-12 fw-normal text-muted text-truncate-1-line"></span>
                                        </h5>
                                        <a class="btn btn-primary" href="<?= base_url('add_multicenter') ?>">Add
                                            Center</a>
                                    </div>
                                    <!-- shankar -->
                                            ...
                                            <table class="table mg-b-0">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th scope="col">Sports Offered</th>
                                                        <th scope="col">Images</th>
                                                        <th scope="col">Action</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <?php if (!empty($multicenters)) : ?>
                                                    <?php foreach ($multicenters as $center) : ?>
                                                    <tr>
                                                        <td><?= esc($center['id']) ?></td>
                                                        <td><?= esc($center['name']) ?></td>
                                                        <td><?= esc($center['address']) ?></td>
                                                        <td>
                                                            <a href="<?= esc($center['map_url']) ?>"
                                                                target="_blank"><?= esc($center['map_url']) ?></a>
                                                        </td>
                                                        <td>
                                                            <?php 
                        $sports = json_decode($center['sports']);
                        if ($sports) {
                            echo implode(', ', $sports);
                        } else {
                            echo '-';
                        ...
                        ?>
                                                        ...
                                                        <td>
                                                            <?php
                        $images = json_decode($center['images']);
                        if ($images) {
                            foreach ($images as $img) {
                                ?>
                                                            <img src="<?= base_url($img) ?>" alt="Multi-Center Image"
                        ...
                        ?>
                                                        ...
                                                        <td>
                                                            <a href="<?= base_url('edit_multicenter/' . $center['id']) ?>"
                                                                class="btn btn-sm btn-primary">Edit</a>
                                                            <a href="<?= base_url('delete_multicenter/' . $center['id']) ?>"
                                                    ...
                                                    <?php else : ?>
                                                    <tr>
                                                        <td colspan="7">No multi-centers found.</td>
                                                    </tr>
                                                    <?php endif; ?>
                                                </tbody>
                                            </table>
