    ...
    <div class="navbar-wrapper">
        <div class="m-header">
            <a href="index.html" class="b-brand">
                ...
                <img src="http://localhost/NahataSports/assets/images/logo.jpg" alt="" class="logo logo-lg" />
                <img src="http://localhost/NahataSports/assets/images/logo.jpg" alt="" class="logo logo-sm" />
            </a>
        </div>
        ...
        <div class="navbar-content">
            <ul class="nxl-navbar">
                ...
                <li class="nxl-item nxl-hasmenu">
                    <a href="http://localhost/NahataSports/dashboard" class="nxl-link">
                ...
                <li class="nxl-item nxl-hasmenu">
                    <a href="http://localhost/NahataSports/venues_book" class="nxl-link">
                ...
                <li class="nxl-item nxl-hasmenu">
                    ...
                    <ul class="nxl-submenu">
                        <li class="nxl-item"><a class="nxl-link" href="http://localhost/NahataSports/sports">Add
                                Sports</a></li>
                        <li class="nxl-item"><a class="nxl-link" href="http://localhost/NahataSports/sport_banners">Add
                                Sports
                                Bannar</a></li>
                    </ul>
                </li>
                ...
                <li class="nxl-item nxl-hasmenu">
                    ...
                    <ul class="nxl-submenu">
                        <li class="nxl-item"><a class="nxl-link" href="http://localhost/NahataSports/venues">All
                                Venues</a></li>
                        <li class="nxl-item"><a class="nxl-link"
                                href="http://localhost/NahataSports/amenities">Amenities</a></li>
                        <li class="nxl-item"><a class="nxl-link"
                                href="http://localhost/NahataSports/nahata_court">Courts</a></li>
                        <li class="nxl-item"><a class="nxl-link"
                                href="http://localhost/NahataSports/banners">Banners</a></li>
                    </ul>
                </li>
                <li class="nxl-item nxl-hasmenu">
                    <a href="javascript:void(0);" class="nxl-link">
                    ...
                    <ul class="nxl-submenu">
                        ...
                        <li class="nxl-item"><a class="nxl-link" href="http://localhost/NahataSports/coach_sport">Add
                                Coachings
                                Sports</a></li>
                        <!-- <li class="nxl-item"><a class="nxl-link" href="#">Sports Banners</a></li> -->

                        <li class="nxl-item"><a class="nxl-link" href="http://localhost/NahataSports/coaching">Add
                                Coaching</a></li>
                        <li class="nxl-item"><a class="nxl-link" href="http://localhost/NahataSports/batch">Batches</a>
                        </li>
                    </ul>
                </li>
                <li class="nxl-item nxl-hasmenu">
                ...
                <li class="nxl-item nxl-hasmenu">
                    <a href="http://localhost/NahataSports/post_category" class="nxl-link">
                        <span class="nxl-micon"><i class="feather-users"></i></span>
                ...
                <li class="nxl-item nxl-hasmenu">
                    ...
                    <ul class="nxl-submenu">
                        <li class="nxl-item"><a class="nxl-link" href="http://localhost/NahataSports/hero">Hero</a></li>
                        <li class="nxl-item"><a class="nxl-link"
                                href="http://localhost/NahataSports/program">Program</a>
                        </li>
                    </ul>
                </li>
            </ul>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="profileTab" role="tabpanel">
                                <div class="card-body personal-info">
                                    ...
                                    <form action="<?= base_url('save_program') ?>" method="post"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="age_group" class="form-control"
                                                placeholder="e.g. 6-18 yrs" required>
                                        </div>

                                        <div class="mb-3">
                                            <label>Timings</label>
                                            <input type="text" name="timings" class="form-control"
                                                placeholder="e.g. 6:00 AM – 9:00 PM" required>
                                        </div>
