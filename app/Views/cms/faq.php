                                ...
                                <div class="card-body personal-info">
                                    <div class="mb-4 d-flex align-items-center justify-content-between">
                                        <h5 class="fw-bold mb-0 me-4">
                                            <span class="d-block mb-2">Upcoming Events & Announcements</span>
                                            <span class="fs-12 fw-normal text-muted text-truncate-1-line"></span>
                                        </h5>
                                        <a class="btn btn-primary" href="<?= base_url('add_faq') ?>">Add Faq</a>
                                    </div>
                                    <!-- shankar -->
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?= base_url('/edit_faq/'.$faq['id']) ?>"
                                                                class="btn btn-sm btn-primary">Edit</a>
                                                            <a href="<?= base_url('/delete_faq/'.$faq['id']) ?>"
                                                                class="btn btn-sm btn-danger"
                                                                onclick="return confirm('Are you sure to delete this FAQ?')">Delete</a>
                                                        </td>
                                                    </tr>
                                                    <?php endforeach; ?>
                                                    <?php else: ?>
