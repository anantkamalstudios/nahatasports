                            ...
                            <div class="tab-pane fade show active" id="profileTab" role="tabpanel">
                                <div class="card-body personal-info">
                                    <div class="mb-4 d-flex align-items-center justify-content-between">
                                        ...
                                        <a class="btn btn-primary" href="<?= base_url('add_hero') ?>">Add Hero</a>
                                    </div>
                                    <!-- shankar -->
                                            ...
                                            <table class="table mg-b-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><img src="<?= base_url($slide['image']) ?>"
                                                                alt="Slide Image" style="width: 100px;"></td>
                                                        <td>
                                                            <div>Text: <?= esc($slide['button1_text']) ?></div>
                                                            <div>URL: <?= esc($slide['button1_url']) ?></div>
                                                        </td>
                                                        <td>
                                                            <div>Text: <?= esc($slide['button2_text']) ?></div>
                                                            <div>URL: <?= esc($slide['button2_url']) ?></div>
                                                        </td>
                                                        <td>
                                                            <a href="<?= base_url('edit_hero/' . $slide['id']) ?>"
                                                                class="btn btn-sm btn-primary">Edit</a>
                                                            <a href="<?= base_url('delete_hero/' . $slide['id']) ?>"
