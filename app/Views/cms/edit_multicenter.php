            ...
            <div class="row">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="profileTab" role="tabpanel">
                                <div class="card-body personal-info">
                                    <!-- shankar -->
                                    <form action="<?= base_url('update_multicenter/' . $center['id']) ?>" method="post"
                                        enctype="multipart/form-data">
                                        <h4 class="mb-4 fw-bold">Edit Multi-Center</h4>

                                        <!-- Center Name -->
                                        <div class="mb-3">
                                            <label class="form-label fw-semibold">Center Name</label>
                                            <input type="text" name="name" class="form-control"
                                                value="<?= esc($center['name']) ?>" required>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="address" class="form-control" rows="3"
                                                required><?= esc($center['address']) ?></textarea>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="url" name="map_url" class="form-control"
                                                value="<?= esc($center['map_url']) ?>" required>
                                        </div>

                                        <!-- Sports Offered -->
                                        <div class="mb-3">
                                            <label class="form-label fw-semibold">Sports Offered</label>
                                            <input type="text" name="sports" class="form-control"
                                                value="<?= esc($center['sports']) ?>" required>
                                        </div>

                                        <!-- Existing Images (Optional: show thumbnails if you saved image paths) -->
                                        <?php if (!empty($center['images'])): ?>
                                        <div class="mb-3">
                ...
                if (is_array($images)):
                    foreach ($images as $img): ?>
                                                <img src="<?= base_url($img) ?>" alt="Image"
                                        ...
                                        <!-- Upload New Images -->
                                        <div class="mb-3">
                                            <label class="form-label fw-semibold">Upload New Images (Optional)</label>
                                            <input type="file" name="images[]" class="form-control" accept="image/*"
                                                multiple>
                                            <small class="text-muted">Upload to add more images. Leave empty to keep
                                                existing images.</small>
                                        </div>

                                        <button type="submit" class="btn btn-primary w-100">Update Multi-Center</button>
                                    </form>
