...
=======
                    <div class="bg-white rounded-circle shadow-lg position-absolute start-50 translate-middle"
                        style="down: 70px; width: 90px; height: 90px; display: flex; align-items: center; justify-content: center; padding: 10px;">
                        <a href="<?= base_url() ?>"><img src="<?=base_url()?>assets/images/logo.jpg" alt="Logo"
...
=======
                        <form class="w-100 mt-4 pt-2 login_form" id="login_form" action="javascript:void(0)"
                            method="post">
>>>>>>> a00c1d0 (05/07/2025)
                            <div class="mb-4">
...
=======
                                <button class="btn btn-lg btn-primary w-100" name="login_save"
                                    id="login_save">Login</button>
>>>>>>> a00c1d0 (05/07/2025)
                            </div>
                        ...
                        <div class="mt-5 text-muted">
                            ...
                            <a href="<?php echo base_url();?>register" class="fw-bold">Create an Account</a>
                        </div>
                    </div>
                </div>
            </div>
