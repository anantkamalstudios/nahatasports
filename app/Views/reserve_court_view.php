                        ...
                        <section class="post_content">
                            <div class="sc_content content_wrap reservation margin_top_70_imp margin_bottom_90_imp">
                                ...
                                <h4 class="sc_title sc_title_regular sc_align_center">
                                    Discover and Book Top Sports Complexes
                                </h4>
                                <div class="columns_wrap sc_columns" style="gap: 0rem; padding: 1rem 0;">
                                    <!-- Card 1 -->
                                    <div class="w-100">
                                        <a href="<?= base_url() ?>user" class="text-decoration-none text-dark">
                                            <div class="card shadow rounded-4 overflow-hidden position-relative">
                                                <div class="carousel slide sync-carousel" data-bs-interval="3000">
                                                    <div class="carousel-inner">
                                                        <div class="carousel-item active">
                                                            <img src="<?= base_url() ?>assets/theme/images/img(2).webp"
                                                                class="d-block w-100" alt="court">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="card-body">
                                                    ...
                                                    <p class="text-muted mb-2">Sinhgad Rd</p>
                                                </div>
                                            </div>
                                        </a>
                                    </div>
                    ...
                    <div class="content_wrap">
                        ...
                        <div class="content">
                            <div class="post_item post_item_single post_format_standard page">
                                <section class="post_content">
                                    <div class="sc_content content_wrap reservation margin_top_70_imp margin_bottom_90_imp">
                                        <h3 class="sc_title sc_title_underline sc_align_center margin_top_null text_align_center add_color_2 font_weight_600 font_size_3_571em">Select Court</h3>
                                        <h4 class="sc_title sc_title_regular sc_align_center">Discover and Book Top Sports Complexes</h4>
...
<div class="container my-4">
  <div class="row justify-content-center">
      ...
      <a href="<?= base_url() ?>user" class="text-decoration-none text-dark">
        <div class="card shadow rounded-4 overflow-hidden position-relative">
          <div class="carousel slide sync-carousel" data-bs-interval="3000">
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="<?=base_url()?>assets/theme/images/img(2).webp" class="d-block w-100" alt="court">
              </div>
              <div class="carousel-item">
                <img src="<?=base_url()?>assets/theme/images/img.webp" class="d-block w-100" alt="court">
              </div>
            </div>
            <span class="badge bg-success position-absolute bottom-0 end-0 m-2">Bookable</span>
          </div>
          <div class="card-body">
            <h5 class="card-title fw-bold mb-1">Nahata Sports Complex</h5>
            <p class="text-muted mb-2">Sinhgad Rd</p>
          </div>
        </div>
      </a>
    ...
    <!-- Card 2 -->
    <div class="col-md-4 mb-4">
      <a href="<?= base_url() ?>sports_comp" class="text-decoration-none text-dark">
        <div class="card shadow rounded-4 overflow-hidden position-relative">
          <div class="carousel slide sync-carousel" data-bs-interval="3000">
            <div class="carousel-inner">
              <div class="carousel-item active">
          ...
          <div class="card-body">
            <h5 class="card-title fw-bold mb-1">Nahata Sports Complex</h5>
            <p class="text-muted mb-2">Gangadham Chowk</p>
          </div>
        </div>
      </a>
    </div>
...
<script type="text/javascript" src="<?php echo base_url()?>assets/script/sign_up.js"></script>
  ...
  document.addEventListener('DOMContentLoaded', function () {
    const carousels = document.querySelectorAll('.sync-carousel');
