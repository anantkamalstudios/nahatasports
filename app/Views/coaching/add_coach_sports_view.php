                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="profileTab" role="tabpanel">
                                <div class="card-body personal-info">
                                    <form class="w-100 mt-4 pt-2 coach_sport_form" id="coach_sport_form" action="javascript:void(0)" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-4 align-items-center">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control" id="sport_title" name="sport_title" placeholder="Sport Title">
                                        </div>
                                    </div>
                                    <div class="row mb-4 align-items-center">
                                        <div class="col-lg-4">
                                        ...
                                        <div class="col-lg-8">
                                            <input id="sport_bannar_image" name="sport_bannar_image" type="file" accept="image/*" class="form-control">
                                        </div>
                                    </div>
                                  ...
                                  <!-- Editable area -->
                                  <div class="container my-5">
                                    <textarea class="form-control" id="about_sport" name="about_sport" style="min-height: 200px;">Start typing here...</textarea>
                                </div>
                                </div>
                                  ...
                                  <!-- Editable area -->
                                  <div class="container my-5">
                                    <textarea class="form-control" id="benefits_sports" name="benefits_sports" style="min-height: 200px;">Start typing here...</textarea>
                                </div>
                                </div>
                                ...
                                <div class="container my-5">
                                  ...
                                  <!-- Editable area -->
                                  <div class="container my-5">
                                    <textarea class="form-control" id="future_prospects" name="future_prospects" style="min-height: 200px;">Start typing here...</textarea>
                                </div>
                                </div>
                                    
                                    <div class="mt-5 text-muted">
                                        <a class="btn btn-lg btn-primary w-100" name="add_coach_sport_submit" id="add_coach_sport_submit">Submit</a>
                                    </div>
...
<script type="text/javascript" src="<?php echo base_url()?>assets/script/add_coach_sport.js"></script>
